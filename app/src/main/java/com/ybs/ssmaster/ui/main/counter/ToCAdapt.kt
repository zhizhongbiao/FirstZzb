 ...
 * @Version: 1.0
 */
class ToCAdapt(private val onItemClickCb: ((
                   v: View,
                   adapter: ToCAdapt,
                   data: Row,
                   pos: Int
    ...
    BaseRvAdpt<Row, ItemCountPlanBinding>() {
    ...
    private fun initClick(
        ...
        vh.binding.btnCount.tag = pos
        vh.binding.btnEndCount.tag = pos
        vh.binding.tvName.tag = pos
        vh.binding.tvName.setOnClickListener(this)
        vh.binding.btnCount.setOnClickListener(this)
        vh.binding.btnEndCount.setOnClickListener(this)
    }
